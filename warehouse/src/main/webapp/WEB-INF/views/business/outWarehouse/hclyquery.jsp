...
<div id="tt" class="easyui-tabs" style="width: 100%;">
	<div title="耗材领用查询" style="padding: 20px; display: none;">
		...
		<table style="float: left;">
			<tr>
				<security:authorize ifAllGranted="ROLE_SYSTEM_SYS_ROLE_ADD">
					<td>
						<button onclick="javascript:addFun()">耗材领用</button>
					</td>
				</security:authorize>
			</tr>
		</table>
...
<script type="text/javascript">
	...
	function selectSb(value) {
		if(value!='' && value!='undefined') {
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?wply=1&lx=2&dqzt=1',
				 valueField:'sbid',
				 textField:'pm',
				 editable:true,
				 value:value,
...
<!-- 添加编辑模态框 -->
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px;display:none;" closed="true" buttons="#dlg-buttons" title="耗材领用管理">
	<form action="" id="dlgForm">
		<table style="margin:auto">
			...
			<tr>
				<td>物品编码:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;width: 250px;" type="text" id="zcbm" value=""  /></td>
			</tr>
			<tr>
				<td>物品名称:</td>
...
<!-- 查看页面 -->
<div id="dlgshow" class="easyui-dialog" style="width: 400px; height: 470px;display:none;" closed="true" buttons="#dlgshow-buttons" title="耗材领用查看">
	<form action="" id="dlgFormshow">
		<table style="margin:auto">
			<tr>
				<td>物品编码:</td>
				<td><input style="width: 200px; height: 20px;" readonly="readonly"  type="text" id="show_zcbm" value=""  class="easyui-textbox"/></td>
			</tr>
			<tr>
				<td>物品名称:</td>
