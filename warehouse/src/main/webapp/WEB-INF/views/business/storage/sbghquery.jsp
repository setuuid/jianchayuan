...
<div id="tt" class="easyui-tabs" style="width: 100%;">
	<div title="设备归还查询" style="padding: 20px; display: none;">
...
<script type="text/javascript">
	...
	function selectSb(value) {
		if(value!='' && value!='undefined') {
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?lx=1&wply=1&isly=Y',
				 valueField:'sbid',
				 textField:'pm',
				 editable:true,
				 value:value,
			...
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?lx=1&dqzt=2',
				 valueField:'sbid',
				 textField:'pm',
				 editable:false,
				 onChange:function(nv,ov) {
...
<!-- 添加编辑模态框 -->
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px;display:none;"  closed="true" buttons="#dlg-buttons" title="设备归还">
...
<!-- 查看页面 -->
<div id="dlgshow" class="easyui-dialog" style="width: 400px; height: 470px;display:none;" closed="true" buttons="#dlgshow-buttons" title="设备归还查看">
