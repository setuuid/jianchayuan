...
function getAttachMents(attachments){
	...
	for(var i=0;i<attachments.length;i++){
		...
		if("xls"==type ||"xlsx"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/excel.png' /><a target='_blank' href='"+__rootPath+"/scripts/PDFShow/web/viewer.html?file="+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</a></span>");
		}else if("doc"==type||"docx"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/doc.png' /><a target='_blank' href='"+__rootPath+"/scripts/PDFShow/web/viewer.html?file="+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if("ppt"==type||"pptx"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/ppt.png' /><a target='_blank' href='"+__rootPath+"/scripts/PDFShow/web/viewer.html?file="+__rootPath+"/sys/core/file/download/"+fileId+".do'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}else if("pdf"==type){
			aryFile.push("<br><img src='"+__rootPath+"/styles/icons/pdf.png' /><a target='_blank' href='"+__rootPath+"/sys/core/file/previewOffice.do?fileId="+fileId+"'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
			...
			aryFile.push("<br><a target='_blank' href='"+__rootPath+"/sys/core/file/previewFile.do?fileId="+fileId+"'><span style='color:#4f50f2;' >"+fileName+"</span></a>");
		}
		
		if("true"==isDown){
			aryFile.push("<a target='_blank'  href='"+__rootPath+"/sys/core/file/previewFile.do?fileId="+fileId+"'><image style='margin-left:15px;cursor:pointer;border:0;' href='"+__rootPath+"/sys/core/file/previewOffice.do?fileId="+fileId+"'  src='"+__rootPath+"/styles/icons/download.png'  /></a>");
		}
		if("true"==isPrint){
			aryFile.push("<a target='_blank' href='"+__rootPath+"/sys/core/file/previewOffice.do?print=true&fileId="+fileId+"'><image style='margin-left:15px;cursor:pointer;border:0;'  src='"+__rootPath+"/styles/icons/printer.png' /></a>");
		}
	}
	return aryFile.join("");
}
 ...
 * @returns
 */
function setComboxData(alias,params,targetCtl,valField,nameField){
	targetCtl.textField=nameField;
	targetCtl.valueField=valField;
