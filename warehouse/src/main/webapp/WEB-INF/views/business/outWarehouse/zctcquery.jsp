...
<div id="tt" class="easyui-tabs" style="width: 100%;">
	<div title="资产调出查询" style="padding: 20px; display: none;">
		...
		<table style="float: left;">
			<tr>
				<security:authorize ifAllGranted="ROLE_SYSTEM_SYS_ROLE_ADD">
					<td>
						<button onclick="javascript:addFun()">资产调出</button>
					</td>
				</security:authorize>
			</tr>
		</table>
...
<script type="text/javascript">
	...
	function selectSb(value) {
		if(value!='' && value!='undefined') {
			...
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?wply=2&gh=1',
				 valueField:'sbid',
				 textField:'pm',
				 editable:true,
				 onChange:function(nv,ov) {
...
<!-- 添加编辑模态框 -->
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px;display:none;" closed="true" buttons="#dlg-buttons" title="资产调出管理">
...
<!-- 查看页面 -->
<div id="dlgshow" class="easyui-dialog" style="width: 400px; height: 470px;display:none;" closed="true" buttons="#dlgshow-buttons" title="资产调出查看">
