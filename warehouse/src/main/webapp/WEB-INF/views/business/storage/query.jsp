...
<div id="tt" class="easyui-tabs" style="width: 100%;">
	<div title="入库查询" style="padding: 20px; display: none;">
		<table id="jyss" border="1" bordercolor="#8DB2E3" title="信息查询" style="border-collapse: collapse; width: 100%;">
			...
			<tr>
				...
				<td style="text-align: center; background-color: #f2f2f2;">入库时间:</td>
				<td>
				...
				<td style="text-align: center; background-color: #f2f2f2;">入库位置：</td>
				<td><select class="easyui-combobox" id="hjxxids" name="hjmc" style="width: 150px; height: 20px;"></select></td>
			</tr>
		</table>
...
<script type="text/javascript">
		...
		$('#dg').datagrid({
			...
			columns : [ [ {
				...
				formatter : function(value, row, index) {
					...
					str += '&nbsp;&nbsp;&nbsp;&nbsp;';
					str += $.formatString('<security:authorize ifAllGranted="ROLE_SYSTEM_SYS_ROLE_DELETE"><a href="javascript:void(0)" onclick="showFun(\'{0}\');" >查看</a></security:authorize>', row.crkid);
					return str;
				}
			} ] ]
		})
	...
	function search() {
		...
		//var ckmc= $("#ckmc").combobox('getText');
		var ckmc=$("#hjxxids").combobox('getValue');
		$('#dg').datagrid('options').url = "${ctx}/storage/querylist.do", 
		$('#dg').datagrid(
				'load', {
					yjfl: yjfl,
					ejfl: ejfl,
	...
	function selectFun(id){
		 ...
		 $.ajax({
	            url: "${ctx}/storage/queryShow.do?crkid="+id,
	            type: "POST",
	...
	function selectSb(value) {
		if(value!='' && value!='undefined') {
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?wply=1',
				 valueField:'sbid',
				 textField:'pm',
				 editable:true,
				 value:value,
	...
	function save() {
        ...
        data["hjxxid"] = $("#hjxxid").combotree('getValue');
      //  data["ckcm"] = $("#ckcm").combotree('getValue'); 
        data["lysl"] = $("#lysl").numberspinner('getValue');
        data["crkid"] = $("#crkid").val();
        if($("#lx").val()=='设备' || $("#lx").val()=='耗材'){
        	data["lx"]='1';
        }else{
        ...
        if(data.sbid == jyzd) {
         ...
         $.ajax({
            url: "${ctx}/storage/editStorage.do",
            type: "POST",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
	...
	function deleteFun(id) {
		parent.$.messager.confirm('询问', '您是否要删除当前数据？',
				function(b) {
					if (b) {
						$.post('${ctx}/storage/deleteStorage.do?crkid='+id, {
							id : id
						}, function(result) {
	...
	function editFun(id) {
		 $.ajax({
	            url: "${ctx}/storage/editShow.do?crkid="+id,
	            type: "POST",
	            contentType: "application/json;charset=utf-8",
	            dataType: "json",
	            success: function (data) {
...
<!-- 添加编辑模态框 -->
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px;display:none;" closed="true" buttons="#dlg-buttons" title="入库管理">
	<form action="" id="dlgForm">
		<table style="margin:auto">
			...
			<tr>
				<td>物品型号:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="zcxh" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			<tr>
				<td>物品规格:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="zcgg" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			<tr>
				<td>一级分类:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="edit_yjfl" value=""  style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>二级分类:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="edit_ejfl" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			<tr>
				<td>三级分类:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="edit_sjfl" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			<tr>
				<td>物品数量:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="sl" value=""  style="width: 150px; height: 20px;"/></td>
			</tr>
			 <tr>
				<td>类型</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="lx" value=""  style="width: 150px; height: 20px;"/></td>
			
			</tr>
			<tr>
				<td>货架</td>
				<td>
					<select data-options="required:true" class="easyui-combobox"  id="hjxxid" name="hjxxid" style="width: 150px; height: 20px;">
					</select>
				</td>
			</tr>
			<!-- <tr>
			...
			<tr>
				...
				<td>
					...
					<input id="crkid" name="crkid" type="hidden"  style="width: 150px; height: 20px;"/>
					<input id="lx" name="lx" type="hidden" style="width: 150px; height: 20px;" />
				</td>
			</tr>
		</table>
	</form>
...
<!-- 查看页面 -->
<div id="dlgshow" class="easyui-dialog" style="width: 400px; height: 470px;display:none;" closed="true" buttons="#dlgshow-buttons" title="入库信息查看">
	<form action="" id="dlgFormshow">
		<table style="margin:auto">
			<tr>
				<td>物品编码:</td>
				<td><input readonly="readonly"  type="text" id="show_zcbm" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>物品名称:</td>
				<td><input readonly="readonly" type="text" id="show_wpmc" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>物品型号:</td>
				<td><input readonly="readonly"  type="text" id="show_zcxh" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>物品规格:</td>
				<td><input readonly="readonly"  type="text" id="show_zcgg" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>一级分类:</td>
				<td><input style="width: 150px; height: 20px;" readonly="readonly"  type="text" id="show_yjfl" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>二级分类:</td>
				<td><input style="width: 150px; height: 20px;" readonly="readonly"  type="text" id="show_ejfl" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>三级分类:</td>
				<td><input style="width: 150px; height: 20px;" readonly="readonly"  type="text" id="show_sjfl" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>生产厂商:</td>
				<td><input readonly="readonly"  type="text" id="show_sccs" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>生产日期:</td>
				<td><input readonly="readonly"  type="text" id="show_scrq" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>运维商:</td>
				<td><input readonly="readonly"  type="text" id="show_yws" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>有效期:</td>
				<td><input readonly="readonly"  type="text" id="show_yxq" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>维保电话:</td>
				<td><input readonly="readonly"  type="text" id="show_wbdh" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/></td>
			</tr>
			<tr>
				<td>货架</td>
				<td>
					<input readonly="readonly"  type="text" id="show_hj" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/>
				</td>
			</tr>
			<tr>
				<td>领用单位</td>
				<td>
					<input readonly="readonly" type="text" id="show_lydw" value="" class="easyui-textbox" style="width: 150px; height: 20px;"/>
				</td>
			</tr>
			<tr>
				<td>领用数量</td>
				<td>
					<input readonly="readonly" id="show_lysl"  type="text" class="easyui-textbox" style="width: 150px; height: 20px;"/>
				</td>
			</tr>
		</table>
	</form>
