...
<div id="tt" class="easyui-tabs" style="width: 100%;">
	<div title="资产调入查询" style="padding: 20px; display: none;">
		<table id="jyss" border="1" bordercolor="#8DB2E3" title="信息查询" style="border-collapse: collapse; width: 100%;">
			...
			<tr>
				...
				<td style="text-align: center; background-color: #f2f2f2;">调入时间:</td>
				<td>
				...
				<td style="text-align: center; background-color: #f2f2f2;">调入单位:</td>
...
<script type="text/javascript">
	...
	function selectSb(value) {
		if(value!='' && value!='undefined') {
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?wply=2',
				 valueField:'sbid',
				 textField:'pm',
				 editable:true,
				 value:value,
			...
			$("#sbid").combobox({
				 url:'${ctx}/sbb/selectSbCombobox.do?wply=2&dqzt=1',
				 valueField:'sbid',
				 textField:'pm',
				 editable:false,
				 onChange:function(nv,ov) {
...
<!-- 添加编辑模态框 -->
<div id="dlg" class="easyui-dialog" style="width: 400px; height: 350px;display:none;" closed="true" buttons="#dlg-buttons" title="资产调入">
	<form action="" id="dlgForm">
		<table style="margin:auto">
			...
			<tr>
				<td>物品编码:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="zcbm" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			<tr>
				<td>物品名称:</td>
				<td><input readonly="readonly" style="border: 0px;outline:none;" type="text" id="wpmc" value="" style="width: 150px; height: 20px;" /></td>
			</tr>
			 <tr>
				<td>物品型号:</td>
...
<!-- 查看页面 -->
<div id="dlgshow" class="easyui-dialog" style="width: 400px; height: 470px;display:none;" closed="true" buttons="#dlgshow-buttons" title="资产调入查看">
